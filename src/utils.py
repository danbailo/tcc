...
def mongo_to_df() -> pd.DataFrame:
    ...
    for answer in Answer.objects:
        # Pega cada documento da coleção e converte esse em json, depois cada
        # json é convertido num dicionário e é criado uma lista de dicionarios
        # para a criação de um dataframe
